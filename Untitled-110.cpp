    ...
    void setdata()
    {
        ...
        switch(choice)
        {
            case 1:
            {
                ...
                cin>>gmail;
                cout<<"\n (iv). Generate the Report-card of how many students: " ;
                cin>>n;
                for(int i=0;i<n;i++)
                {
                    cout<<"\n-->Enter the Name of the Subject and then marks: ";
                    cin>>sub>>arr[i];
                }
            }
            break;
